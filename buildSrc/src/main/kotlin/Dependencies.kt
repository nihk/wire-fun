object Dependencies {
    ...
    object Wire {
        const val runtime = "com.squareup.wire:wire-runtime:${Versions.wire}"
        const val plugin = "com.squareup.wire:wire-gradle-plugin:${Versions.wire}"
        const val grpcClient = "com.squareup.wire:wire-grpc-client:${Versions.wire}"
    }
